...
const svgIcons = {
    ...
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path opacity="0.3" d="M0 14.25V18H3.75L14.81 6.94L11.06 3.19L0 14.25ZM17.71 4.04C18.1 3.65 18.1 3.02 17.71 2.63L15.37 0.289998C14.98 -0.100002 14.35 -0.100002 13.96 0.289998L12.13 2.12L15.88 5.87L17.71 4.04Z" fill="black"/>
    </svg>
  `,
    delete: `
...
export function ActionBtn(action, onClick, className = "action-btn") {
    const btn = document.createElement("button");
    btn.type = "button";
    btn.className = className;
    btn.innerHTML = svgIcons[action];
    if (onClick) {
        btn.onclick = onClick;
    }
    return btn;
